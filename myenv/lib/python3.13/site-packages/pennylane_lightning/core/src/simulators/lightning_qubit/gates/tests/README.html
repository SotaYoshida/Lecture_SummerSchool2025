...
<html lang="ja" data-content_root="../../../../../../../../../../../" >
  ...
  <head>
    ...
    <title>C++ tests for PennyLane-Lightning &#8212; Julia言語による原子核構造計算入門</title>
...
<link rel="preload" as="script" href="../../../../../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'myenv/lib/python3.13/site-packages/pennylane_lightning/core/src/simulators/lightning_qubit/gates/tests/README';</script>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/SotaYoshida/Lecture_SummerSchool2025/issues/new?title=Issue%20on%20page%20%2Fmyenv/lib/python3.13/site-packages/pennylane_lightning/core/src/simulators/lightning_qubit/gates/tests/README.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../../../../../_sources/myenv/lib/python3.13/site-packages/pennylane_lightning/core/src/simulators/lightning_qubit/gates/tests/README.md" target="_blank"
...
<div id="jb-print-docs-body" class="onlyprint">
    <h1>C++ tests for PennyLane-Lightning</h1>
    <!-- Table of contents -->
...
<div id="searchbox"></div>
  ...
  <section class="tex2jax_ignore mathjax_ignore" id="c-tests-for-pennylane-lightning">
<h1>C++ tests for PennyLane-Lightning<a class="headerlink" href="#c-tests-for-pennylane-lightning" title="Link to this heading">#</a></h1>
<p>Gate implementations (kernels) are tested in <code class="docutils literal notranslate"><span class="pre">Test_GateImplementations_*.cpp</span></code> files.</p>
<p>As some of the kernels (AVX2 and AVX512) are only runnable on the corresponding architectures, we cannot guarantee testing all kernels on all CPU variants.
Even though it is possible to test available kernels by detecting the architecture, we currently use the approach below to simplify the test codes:</p>
<p>In <code class="docutils literal notranslate"><span class="pre">Test_GateImplementations_(Param|Nonparam|Matrix).cpp</span></code> files we test only the default kernels (<code class="docutils literal notranslate"><span class="pre">LM</span></code> and <code class="docutils literal notranslate"><span class="pre">PI</span></code>), of which both paradigms are architecture agnostic.</p>
<p>In <code class="docutils literal notranslate"><span class="pre">Test_GateImplementations_(Inverse|CompareKernels|Generator).cpp</span></code> files run tests registered to <code class="docutils literal notranslate"><span class="pre">DynamicDispatcher</span></code>. As we register kernels to <code class="docutils literal notranslate"><span class="pre">DynamicDispatcher</span></code> by detecting the runtime architecture, these files test all accessible kernels on the executing CPU architecture.</p>
</section>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./myenv/lib/python3.13/site-packages/pennylane_lightning/core/src/simulators/lightning_qubit/gates/tests"
        },
