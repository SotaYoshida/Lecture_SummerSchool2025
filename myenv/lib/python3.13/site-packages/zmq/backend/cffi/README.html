...
<link rel="preload" as="script" href="../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'myenv/lib/python3.13/site-packages/zmq/backend/cffi/README';</script>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/SotaYoshida/Lecture_SummerSchool2025/issues/new?title=Issue%20on%20page%20%2Fmyenv/lib/python3.13/site-packages/zmq/backend/cffi/README.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../_sources/myenv/lib/python3.13/site-packages/zmq/backend/cffi/README.md" target="_blank"
...
<div id="searchbox"></div>
  ...
  <p>PyZMQ's CFFI support is designed only for (Unix) systems conforming to <code class="docutils literal notranslate"><span class="pre">have_sys_un_h</span> <span class="pre">=</span> <span class="pre">True</span></code>.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./myenv/lib/python3.13/site-packages/zmq/backend/cffi"
        },
