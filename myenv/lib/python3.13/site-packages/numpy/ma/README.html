...
<html lang="ja" data-content_root="../../../../../../" >
  ...
  <head>
    ...
    <title>A Guide to Masked Arrays in NumPy &#8212; Julia言語による原子核構造計算入門</title>
...
<link rel="preload" as="script" href="../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'myenv/lib/python3.13/site-packages/numpy/ma/README';</script>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/SotaYoshida/Lecture_SummerSchool2025/issues/new?title=Issue%20on%20page%20%2Fmyenv/lib/python3.13/site-packages/numpy/ma/README.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../_sources/myenv/lib/python3.13/site-packages/numpy/ma/README.rst" target="_blank"
...
<h1><a class="toc-backref" href="#id2" role="doc-backlink">A Guide to Masked Arrays in NumPy</a><a class="headerlink" href="#a-guide-to-masked-arrays-in-numpy" title="Link to this heading">#</a></h1>
<nav class="contents" id="id1">
<p class="topic-title">目次</p>
<ul class="simple">
<li><p><a class="reference internal" href="#a-guide-to-masked-arrays-in-numpy" id="id2">A Guide to Masked Arrays in NumPy</a></p>
<ul>
<li><p><a class="reference internal" href="#history" id="id3">History</a></p></li>
<li><p><a class="reference internal" href="#main-differences" id="id4">Main differences</a></p></li>
<li><p><a class="reference internal" href="#new-features" id="id5">New features</a></p></li>
<li><p><a class="reference internal" href="#using-the-new-package-with-numpy-core-ma" id="id6">Using the new package with numpy.core.ma</a></p></li>
<li><p><a class="reference internal" href="#using-maskedarray-with-matplotlib" id="id7">Using maskedarray with matplotlib</a></p></li>
<li><p><a class="reference internal" href="#masked-records" id="id8">Masked records</a></p></li>
<li><p><a class="reference internal" href="#optimizing-maskedarray" id="id9">Optimizing maskedarray</a></p></li>
<li><p><a class="reference internal" href="#should-masked-arrays-be-filled-before-processing-or-not" id="id10">Should masked arrays be filled before processing or not?</a></p></li>
<li><p><a class="reference internal" href="#thanks" id="id11">Thanks</a></p></li>
<li><p><a class="reference internal" href="#revision-notes" id="id12">Revision notes</a></p></li>
</ul>
</li>
</ul>
</nav>
...
<section id="history">
<h2><a class="toc-backref" href="#id3" role="doc-backlink">History</a><a class="headerlink" href="#history" title="Link to this heading">#</a></h2>
...
<h2><a class="toc-backref" href="#id4" role="doc-backlink">Main differences</a><a class="headerlink" href="#main-differences" title="Link to this heading">#</a></h2>
<blockquote>
<div><ul class="simple">
...
<h2><a class="toc-backref" href="#id6" role="doc-backlink">Using the new package with numpy.core.ma</a><a class="headerlink" href="#using-the-new-package-with-numpy-core-ma" title="Link to this heading">#</a></h2>
...
<h2><a class="toc-backref" href="#id7" role="doc-backlink">Using maskedarray with matplotlib</a><a class="headerlink" href="#using-maskedarray-with-matplotlib" title="Link to this heading">#</a></h2>
...
<h2><a class="toc-backref" href="#id8" role="doc-backlink">Masked records</a><a class="headerlink" href="#masked-records" title="Link to this heading">#</a></h2>
...
<h2><a class="toc-backref" href="#id9" role="doc-backlink">Optimizing maskedarray</a><a class="headerlink" href="#optimizing-maskedarray" title="Link to this heading">#</a></h2>
</section>
<section id="should-masked-arrays-be-filled-before-processing-or-not">
<h2><a class="toc-backref" href="#id10" role="doc-backlink">Should masked arrays be filled before processing or not?</a><a class="headerlink" href="#should-masked-arrays-be-filled-before-processing-or-not" title="Link to this heading">#</a></h2>
...
<section id="thanks">
<h2><a class="toc-backref" href="#id11" role="doc-backlink">Thanks</a><a class="headerlink" href="#thanks" title="Link to this heading">#</a></h2>
...
<h2><a class="toc-backref" href="#id12" role="doc-backlink">Revision notes</a><a class="headerlink" href="#revision-notes" title="Link to this heading">#</a></h2>
<blockquote>
<div><ul class="simple">
...
<li><p>01/23/2007 : The package has been moved to the SciPy sandbox, and is regularly updated: please check out your SVN version!</p></li>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./myenv/lib/python3.13/site-packages/numpy/ma"
        },
