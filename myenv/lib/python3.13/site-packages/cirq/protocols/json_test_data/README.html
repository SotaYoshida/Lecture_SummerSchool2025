...
<html lang="ja" data-content_root="../../../../../../../" >
  ...
  <head>
    ...
    <title>&lt;no title&gt; &#8212; Julia言語による原子核構造計算入門</title>
...
<link rel="preload" as="script" href="../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'myenv/lib/python3.13/site-packages/cirq/protocols/json_test_data/README';</script>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/SotaYoshida/Lecture_SummerSchool2025/issues/new?title=Issue%20on%20page%20%2Fmyenv/lib/python3.13/site-packages/cirq/protocols/json_test_data/README.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../_sources/myenv/lib/python3.13/site-packages/cirq/protocols/json_test_data/README.md" target="_blank"
...
<div id="searchbox"></div>
  ...
  <p>This folder contains test data for cirq's JSON serialization functionality.</p>
<p>For more information, see <a class="reference internal" href="#/docs/dev/serialization.md"><span class="xref myst"><code class="docutils literal notranslate"><span class="pre">docs/dev/serialization.md</span></code></span></a>.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./myenv/lib/python3.13/site-packages/cirq/protocols/json_test_data"
        },
